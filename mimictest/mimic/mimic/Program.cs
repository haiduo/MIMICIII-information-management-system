...
namespace mimic
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Host info
            string connstr = GetconnectionStringConfig("PostgreSQL");
             using (var conn = new NpgsqlConnection(connstr))
            {
                ...
                {
                    Console.WriteLine("数据库已经连接并打开!");
                }

                string sql = "set search_path to mimiciii; SELECT DIAGNOSIS FROM admissions limit 3";
                // Retrieve all rows
